...
class TestPub(unittest.TestCase):
    def setUp(self):
        ...
        self.pub = Pub("The Drunken Sailor", 0, drinks_menu, food_menu)
    ...
    #     if drink != None:
    #         price = drink.price
    #         if self.customer1.can_pay_for_drink(price):
    #             self.customer1.reduce_wallet(price)
    #             self.pub.add_to_till(price)
    #     self.assertEqual(4, self.pub.till)
    #     self.assertEqual(2, self.customer1.wallet)

    # def test_sell_a_drink__not_enough_money(self):
    #     drink = self.pub.find_drink_by_name("Whiskey Sour")
    #     if drink != None:
    #         price = drink.price
    #         if self.customer1.can_pay_for_drink(price):
    #             self.customer1.reduce_wallet(price)
    ...
    # def test_sell_a_drink__drink_not_found(self):
    #     drink = self.pub.find_drink_by_name("Pina Collada")
    #     if drink != None:
    #         price = drink.price
    #         if self.customer1.can_pay_for_drink(price):
    #             self.customer1.reduce_wallet(price)
    ...
    # def test_customer_age_above_18__true(self):
    #     of_legal_age = self.pub.get_customer_age(self.customer1)
    #     self.assertEqual(True, of_legal_age)

    # def test_customer_age_above_18__false(self):
    #     of_legal_age = self.pub.get_customer_age(self.customer2)
    #     self.assertEqual(False, of_legal_age)

    # # def test_refuse_service_